                ...
                <>
                    <div className="mx-auto  px-2 md:px-[15%] ">
                        <div className="relative flex h-[95px] items-center justify-between">
                            ...
                            <div className="flex flex-1 h-1/2 items-center justify-center sm:items-stretch sm:justify-start">
                                <div className="flex w-[15%] relative">
                                    <div className="h-full aspect-w-2 aspect-h-1">
                                        <MainLogo />
                                    </div>
                                </div>
