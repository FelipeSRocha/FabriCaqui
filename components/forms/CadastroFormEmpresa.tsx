...
const CadastroFormEmpresa = () => {
  ...
  const handleSubmit = async () => {
    setOnloading(true)
    const { factoryName, CNPJ, address } = formValues
    const payload = {
      factoryName,
      CNPJ,
  ...
  return (
    <div className="flex justify-center sm:mt-8">
      <div
        className={
          formState === 3
            ? "grid grid-rows-2 sm:grid-cols-2 max-w-6xl sm:mt-0 w-screen relative "
            : "sm:mt-0 w-screen relative max-w-3xl "
        }
      >
        <div className="overflow-hidden flex-1 rounded-t-xl sm:rounded-l-xl shadow-lg relative">
          ...
          <div className="bg-gray-50 px-4 py-3 text-right sm:px-6 flex flex-row-reverse justify-between">
            ...
            {changed && formState >= 2 && !cepChanged && (
              <>
                <button
                ...
                >
                  <label>
                    {formState === 2 ? "Avançar" : "Atualizar Mapa"}
                  </label>
                </button>
              </>
            )}
        ...
        {formState === 3 && (
          <div
            className={
              formState === 3
                ? "relative rounded-r-xl rounded-b-xl sm:rounded-r-xl overflow-hidden shadow-lg"
                : ""
            }
          >
